...
#### Quick Command Setup
```
docker run -d --name Mirrorverse  -p 127.0.0.1:2425:8000   -v $(pwd)/Mirrorverse:/app/data     -e AUTHENTICATION_ENABLED=true   -e AUTHENTICATION_PASSWORD=<PASS_HERER>   -e AUTHENTICATION_SECRET_KEY=<KEY_HERE> ghcr.io/gamosoft/notediscovery:latest
```
Also added nginx file (just in case)
